...
### 新增功能
- **task 命令** - 新增 `webforge task` 命令，支持任务管理和操作

### 改进与优化
- **增强 planning 模块** - 改进任务规划和依赖解析逻辑
- **优化 agent-briefing** - 提升代理工作流的上下文传递
- **改进 CLI 索引** - 优化命令加载和初始化性能

### 修复
- 修复 planning 中复杂依赖场景的处理
- 优化 task 命令的错误提示
...
- [v0.2.3 Release](./RELEASE-v0.2.3.md)
